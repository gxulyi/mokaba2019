...
<html>
	...
	<body>
		...
		<div class="mui-content">
			...
			<!-- 知识列表 开始 -->
			<div id="dongtai" class="list white">
			...
			$(function() {
				...
				function findNews(data) {
					...
					for(var i = 0; i < listGoods.length; i++) {
						...
						ahtml += '<div class="default-text-color list-box" onclick=javascript:{window.location="HomeController/dynamic_detail?news_id='+listGoods[i]["news_id"]+'"}>'+
