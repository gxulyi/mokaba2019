...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="title" type="text" data-title="标题"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>作者：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="author" type="text"  data-author="作者"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>简单描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="content_introduction"  data-content_introduction="简单描述"  type="text" class="col-xs-6"/></div></li>
...
<!--  <li class="clearfix">
 ...
 -->  
      ...
      <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>备注：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="remarks" data-remarks="备注" type="text" class="col-xs-6"/></div></li>
     
      <li class="clearfix"><label class="label_name col-xs-1"><i></i>音乐链接：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="audio_url"  data-audio_url="背景音乐"  type="text" class="col-xs-6"/></div></li>
  
       <li class="clearfix"><label class="label_name col-xs-1">
       <i>*</i>发布类型：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
      <select name="audio_url" id="selectidd" class="text_add" style="width:300px" class="col-xs-6">
       <option value="10">新增网页</option>
     ...
     -->
          ...
          <i>*</i>图片链接：&nbsp;&nbsp;</label>
          <input type="hidden" name="pictures_url"  id="pictures_url">
          <style>
          #container{
          margin-left: 80px;
          }
...
var n=0;
 ...
 return false;
  ...
  ajaxPost("<%=basePath%>UEditorTemplateController/AddConten",object,"json","json",AddConten);
   ...
   alert("提交成功");
      window.location.href="weixinAdminController/WebpageList"; 
