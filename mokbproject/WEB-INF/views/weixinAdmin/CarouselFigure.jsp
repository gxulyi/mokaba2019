...
<div class="margin clearfix">
 ...
 var article_type= $("#selectidd").find("option:selected").val();
    ...
    window.location.href="weixinAdminController/CarouselFigure?article_type="+article_type; 
 ...
 %>		   
     ...
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
      ...
      <a   href="UEditorTemplateController/SelectArticleDatail?article_id=<%=m.get("article_id") %>" title="查看"  class="btn btn-xs btn-success">查看</a>   
            <a  href="weixinAdminController/EditCarouselFigure?article_id=<%=m.get("article_id") %>" title="编辑"  href="javascript:;"  class="btn btn-xs btn-info" >编辑</a> 
