		...
		<div class="mui-content">
			...
			<div class="mdfd-content">
				...
				<div class="user-order">
					<a class="order" href="maid/myorder?order_status=3"> <i class="iconfont shade icon-daifahuo"></i> <span>赠品待发</span> </a>
					<a class="order" href="maid/myorder?order_status=4"> <i class="iconfont shade icon-daishouhuo"></i> <span>赠品待收</span> </a>
					<a class="order" href="maid/myorder?order_status=5"> <i class="iconfont shade icon-daipingjia"></i> <span>赠品评价</span> </a>
					<a class="order"> <i class="iconfont shade icon-tuikuan"></i> <span>售后</span>
					</a>
				</div>
				...
				<div class="address">
					<div onclick="javascript:{window.location='maid/newaddress';};"><span>添加收货地址</span> </div>
				</div>
			</div>
