...
<html>
	...
	<body>
		...
		<div class="mui-content">
			...
			<!-- 知识列表 开始 -->
			<div id="shangpingList" class="list white"></div>
			<!-- 知识列表  结束 -->
		</div>
				...
				function findNews(data) {
					if(data.state==0){
						...
						for(var i = 0; i < listGoods.length; i++) {
							...
							Ahtml += '<div class="default-text-color list-box" onclick=javascript:{window.location="HomeController/knowledge_detail?news_id=' + listGoods[i]["news_id"] + '"}>'+
