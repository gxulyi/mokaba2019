...
<div class="margin clearfix">
 ...
 <div class="search_style">
   ...
   <li style="width:90px;" onclick="select()"><button type="button" class="btn_search"><i class="icon-search"></i>查询</button></li>
      </ul>
    </div>
 ...
 //UEditorTemplateController/ArticleList?article_type=1
     ...
     <div class="border clearfix">
       <span class="l_f">
        ...
        <a href="UEditorTemplateController/UEditor" class="btn btn-sm btn-primary"><i class="fa fa-check"></i>&nbsp;添加网页</a>
 ...
 %>		   
     ...
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
      ...
      <a   href="UEditorTemplateController/SelectArticleDatail?article_id=<%=m.get("article_id") %>" title="查看"  class="btn btn-xs btn-success">查看</a>   
            <a  href="UEditorTemplateController/UpdataUEditor?article_id=<%=m.get("article_id") %>" title="编辑"  href="javascript:;"  class="btn btn-xs btn-info" >编辑</a> 
              <a  onclick="qunfa(<%=m.get("article_id") %>)" title="编辑"  href="javascript:;"  class="btn btn-xs btn-info" >群发</a>           
     <a  href="javascript:;"  onclick="member_del(this,'<%=m.get("article_id") %>')" title="删除" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
          </td>
        </tr>
