...
<body>
 ...
 <!--顶部-->
  <div class="Sellerber_header apex clearfix" id="Sellerber_header">
   ...
   <div class="news l_f"><a href="javascript:void()" class="fa  fa-bell "></a><em>5</em></div>
     <div class="administrator l_f">
       ...
       <ul class="dropdown-menu">
        <li><a href="javascript:void()"><i class="fa fa-user"></i>个人信息</a></li>
        <li><a href="javascript:void()"><i class="fa fa-cog"></i>系统设置</a></li>
...
<!--左侧-->
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <div class="skin_select">
      <ul class="dropdown-menu dropdown-caret">
         ...
         <li><a class="colorpick-btn" href="javascript:void()" data-val="blue" style="background-color:#438EB9;" ></a></li>
         <li><a class="colorpick-btn" href="javascript:void()" data-val="green" style="background-color:#72B63F;" ></a></li>
         <li><a class="colorpick-btn" href="javascript:void()" data-val="blue" style="background-color:#D0D0D0;" ></a></li>
         <li><a class="colorpick-btn" href="javascript:void()" data-val="blue" style="background-color:#FF6868;" ></a></li>
        </ul>     
     </div>
     <div class="search_style">
        <form action="javascript:void()" method="get" class="sidebar_form">
    ...
    <dl class="nav nav-list" id="menu_list">
     ...
     <dd class="submenu">
       <ul>
         <li class="home"><a href="javascript:void(0)" name="admin_store/toAddStore2" title="新增商品" class="iframeurl"><i class="fa fa-angle-double-right"></i>新增商品</a></li>
         <li class="home"><a href="javascript:void(0)" name="admin_store/adminFindStore" title="产品管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>产品管理</a></li>
  ...
  <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-database"></i><span class="menu-text"> 订单管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="admin_order/adminFindOrder" title="订单类表" class="iframeurl"><i class="fa fa-angle-double-right"></i>订单类表</a></li>
       <li class="home"><a href="javascript:void(0)" name="admin_order/adminSendOrder" title="发货" class="iframeurl"><i class="fa fa-angle-double-right"></i>发货</a></li>
       ...
       <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-credit-card"></i><span class="menu-text"> 支付管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
      ...
      <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa  fa-th-list"></i><span class="menu-text"> 店铺管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       ...
       <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa  fa-file-photo-o"></i><span class="menu-text"> 审核管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="admin_examine/toAdminExamineByStatus" title="商品审核列表" class="iframeurl"><i class="fa fa-angle-double-right"></i>商品审核列表</a></li>
       <li class="home"><a href="javascript:void(0)" name="admin_examine/adminExNews" title="新闻审核列表" class="iframeurl"><i class="fa fa-angle-double-right"></i>新闻审核列表</a></li>
       <li class="home"><a href="javascript:void(0)" name="Category_Manage.html" title="分类管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>分类管理</a></li>
       </ul>
      </dd>
  <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-bar-chart"></i><span class="menu-text"> 报表管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       ...
       <li class="home"><a href="javascript:void(0)" name="Category_Manage.html" title="分类管理" class="iframeurl"><i class="fa fa-angle-double-right"></i>交易量</a></li>
        ...
        <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-user"></i><span class="menu-text"> 会员管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
      ...
      <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-cogs"></i><span class="menu-text"> 系统管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       ...
       <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-file-text-o"></i><span class="menu-text"> 优惠券管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="admin_voucher/adminAddVoucher" title="添加优惠券" class="iframeurl"><i class="fa fa-angle-double-rightt"></i>添加优惠券</a></li>
       <li class="home"><a href="javascript:void(0)" name="admin_obtainAward/toAddAward" title="新增奖项" class="iframeurl"><i class="fa fa-angle-double-rightt"></i>新增奖项</a></li>
       <li class="home"><a href="javascript:void(0)" name="admin_obtainAward/toFindAdminAward" title="奖项列表" class="iframeurl"><i class="fa fa-angle-double-rightt"></i>奖项列表</a></li>
       </ul>
      </dd>
       <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa  fa-hdd-o "></i><span class="menu-text"> 微信管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="weixinAdminController/addAutoReturn" title="新增文章" class="iframeurl"><i class="fa fa-angle-double-rightt"></i>新增文章</a></li>
       </ul>
      </dd>
        <dt class="nav_link"><a href="javascript:void(0)" class="dropdown-toggle title_nav"><i class="fa fa-file-text-o"></i><span class="menu-text">文章管理</span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       <li class="home"><a href="javascript:void(0)" name="admin_news/adminAddNews" title="添加文章" class="iframeurl"><i class="fa fa-angle-double-right"></i>添加文章</a></li>
       <li class="home"><a href="javascript:void(0)" name="admin_news/autoReturnNews" title="文章列表" class="iframeurl"><i class="fa fa-angle-double-rightt"></i>文章列表</a></li>
       </ul>
      </dd>
       <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-users"></i><span class="menu-text">管理员管理 </span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
       ...
       <dt class="nav_link"><a href="javascript:void()" class="dropdown-toggle title_nav"><i class="fa fa-wrench"></i><span class="menu-text">界面工具</span><b class="arrow fa fa-angle-down"></b></a></dt>
    <dd class="submenu">
     <ul>
...
<!--内容-->
  <div class="Sellerber_content" id="contents">
    <div class="breadcrumbs" id="breadcrumbs">
	  ...
	  <ul class="breadcrumb clearfix" id="min_title_list">
        <li class="active home"><span title="我的桌面" data-href="<%=basePath%>admin_bank/findAllBank"><i class="fa fa-home home-icon"></i>首页</span></li>
      </ul>
      </div>
  ...
  <div class="show_iframe" id="show_iframe">
       <iframe scrolling="yes" class="simei_iframe" frameborder="0" src="admin/index" name="iframepage" data-href="admin/index"></iframe>
       </div>
      </div>
  </div>
<!--底部-->
...
$("body").bind("keydown",function(event){
     if (event.keyCode == 116) {
          ...
          $("#main_frame").attr("src",window.frames["Sellerber"].src);
