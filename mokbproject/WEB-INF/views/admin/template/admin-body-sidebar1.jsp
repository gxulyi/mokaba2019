...
<div class="admin-sidebar">
    ...
    <li><a href="admin/index"><span class="am-icon-home"></span>&nbsp;&nbsp;首页</a> </li>
     ...
     <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#kdsjf'}"><span class="am-icon-file"></span>&nbsp;&nbsp;回复管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
      ...
      <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#kdsjf1'}"><span class="am-icon-file"></span>&nbsp;&nbsp;轮播图管理<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub " id="kdsjf1">
       ...
       <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#kdsjf12'}"><span class="am-icon-file"></span>&nbsp;&nbsp;公司简介管理<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
       ...
       <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#kdsjf123'}"><span class="am-icon-file"></span>&nbsp;&nbsp;群发功能<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub " id="kdsjf123">
     ...
     <li class="admin-parent">
      ...
      <li class="admin-parent">
        ...
        <ul class="am-list am-collapse admin-sidebar-sub " id="filiale">
          <li><a href="admin_company/adminLeadfounder" class="am-cf"><span class=""></span>公司销售量</a></li>
          <li><a href="admin_company/index" class="am-cf">公司管理</a></li>
