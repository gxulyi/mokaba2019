...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="title" type="text" data-title="标题" value="${sEntity.sowing_title}"  id="title" class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1">
       <i>*</i>类型：&nbsp;&nbsp;</label>
    <div class="Add_content col-xs-11">
      <select name="" id="selectidd" class="text_add" style="width:300px" class="col-xs-6" value="">
  ...
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>顺序：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input name="author" value="${sEntity.sort}" type="text"  data-author="顺序" id="sort"   class="col-xs-6"/></div></li>
   ...
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>类型名称：&nbsp;&nbsp;</label>
       <div class="am-btn-group am-btn-group-xs">
            ...
            <div class="am-form-group am-margin-left am-fl" >
              ...
              <select id="sowingMode" name="sowingMode" onchange="showStore(this.value)">
