...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input style="width:180px" name="title" type="text" data-title="标题"  id="title" class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1">
       <i>*</i>类型：&nbsp;&nbsp;</label>
    <div class="Add_content col-xs-11">
      <select name="" id="selectidd" class="text_add" style="width:180px" class="col-xs-6">
  ...
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>顺序：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input style="width:180px" name="author" type="text"  data-author="顺序" id="sort"   class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>所属类型：&nbsp;&nbsp;</label>
    <div class="Add_content col-xs-11" id="radioId">
       <input type="radio" value="1" name="store" onclick="function_choose(1)">商品</input>  
   ...
   <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>类型名称：&nbsp;&nbsp;</label>
       <div class="am-btn-group am-btn-group-xs">
            ...
            <div class="am-form-group am-margin-left am-fl" >
              <select id="sowingMode" onchange="showStore(this.value)" style="width:180px;">
 ...
 <div class="Button_operation btn_width">
    <button class="btn button_btn bg-deep-blue"  style="margin-left: 30%;" type="button" onclick="addSowing()">保存并提交</button>
  ...
  <script type="text/javascript">
	...
	function showStore(vsi){
	    ...
	    if(vsi.object=="知识动态"){
	      ...
	      for(var i=0;i<nd.length;i++){
           htmlstr2+="<option name='sowing'  value="+nd[i].news_id+">"+nd[i].news_title+"</option>";
		  }
	      ...
	      for(var i=0;i<sbl.length;i++){
           htmlstr2+="<option  name='sowing' value="+sbl[i].article_id+">"+sbl[i].title+"</option>";
		  }
		  document.getElementById("sowingMode").innerHTML=htmlstr2;
		   }else{
			  	alert("暂无服务内容信息");
    ...
    function addSowing(){
	      ...
	      if(sowing_picture ==null ||sowing_picture==""){
	        alert("请上传轮播图图片");
	        return;
	      }
	       
	      var paramData;
	 	  var paramData={type_id:type_id,sowing_title:sowing_title,sowing_mode:sowing_mode,sowing_type:sowing_type,sort:sort,sowing_picture:sowing_picture};                               
	  	  var object = JSON.stringify(paramData);
	  	  //alert(object);
	 	  if(confirm("确认执行这个操作吗？")){
	        ajaxPost("<%=basePath%>/admin_sowing/addSowing",object,"json","json",wait);
	  }else{
	    return false;
	    }
    ...
    function tijiao(){
		...
		var n=0;
		 ...
		 return false;
		  ...
		  ajaxPost("<%=basePath%>UEditorTemplateController/AddConten",object,"json","json",AddConten);
