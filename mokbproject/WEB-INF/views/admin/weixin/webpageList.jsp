...
listMap=(List<HashMap<String, Object>>)request.getAttribute("listMap");
 ...
 %>		   
     ...
     <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
          ...
          <td class="td-status"> <a  target="_blank"  href="UEditorTemplateController/SelectArticleDatail?article_id=<%=m.get("article_id") %>">http://www.shmedifood.com/medicinefood/UEditorTemplateController/SelectArticleDatail?article_id=<%=m.get("article_id") %></a></td> 
          <td class="td-manage">
      <a target="_blank"  href="UEditorTemplateController/SelectArticleDatail?article_id=<%=m.get("article_id") %>" title="查看"  class="btn btn-xs btn-success">查看</a>   
            <a  href="weixinAdminController/EditWebpageList?article_id=<%=m.get("article_id") %>" title="编辑"  href="javascript:;"  class="btn btn-xs btn-info" >编辑</a> 
