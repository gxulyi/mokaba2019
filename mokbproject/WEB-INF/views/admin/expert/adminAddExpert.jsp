...
<script type="text/javascript">
	function wait(data){
     ...
     //     alert("expert_expert::"+expert_expert);
	      ...
	      var paramData;
	      //var paramData={expert_academic:expert_academic,exper_picture:exper_picture,expert_expert:expert_expert,userid:userid,expert_name:expert_name};
	 	  var paramData={expert_academic:expert_academic,exper_picture:exper_picture,expert_expert:expert_expert,expert_name:expert_name};                               
	  	  var object = JSON.stringify(paramData);
	 	  ajaxPost("<%=basePath%>/admin_expert/addExpert",object,"json","json",wait);
...
<div class="add_style">
 ...
 <div class="Button_operation btn_width">
    <button class="btn button_btn bg-deep-blue"  style="margin-left: 30%;" type="button" onclick="addexpert()">保存并提交</button>
