...
<script type="text/javascript">
	...
	function returnFind(){
		window.parent.location.href="<%=basePath%>admin_expert/toAdminFindExpert";
	}
	function showExpert(data){
		debugger;
		var eey=data.object[0];
		document.getElementById("userid").value=eey.user_basics_id;
		document.getElementById("expert_academic").value=eey.expert_academic;
		document.getElementById("expert_name").value=eey.expert_name;
		document.getElementById("epiccc").src="/medicinefood/file/store/img/"+eey.expert_portrait;
		ue.setContent(eey.expert_expert);
	}
	function onloadd(){
		...
		var expert_id=document.getElementById("expert_id").value;
	  	...
	  	ajaxPost("<%=basePath%>admin_expert/adminFindExpert",object,"json","json",showExpert);
	};
	...
	function wait(data){
	  ...
	  function updateExpert(){
	  	  var expert_id=document.getElementById("expert_id").value;
	      var exper_picture=document.getElementById("expert_picture").value;
     ...
     //     alert("expert_expert::"+expert_expert);
          var expert_academic=document.getElementById("expert_academic").value;
	      var expert_expert=UE.getEditor('editor').getContent();
	      //alert(expert_expert);
	      var userid=document.getElementById("userid").value;
	      var paramData;
	      if(expert_picture!=null){
	      	var paramData={expert_id:expert_id,expert_academic:expert_academic,exper_picture:exper_picture,expert_expert:expert_expert,userid:userid,expert_name:expert_name};
	      }else{
	      	var paramData={expert_id:expert_id,expert_academic:expert_academic,expert_expert:expert_expert,userid:userid,expert_name:expert_name};
	      }
	 	                                 
	  	  var object = JSON.stringify(paramData);
	 	  ajaxPost("<%=basePath%>/admin_expert/updateExpert",object,"json","json",wait);
...
<body>
	<div>
		<input id="expert_id" value="${ expert_id}" type="hidden">
    	<input id="expert_picture" value="" type="hidden">
    </div>
		   ...
		   <div >
			   <div class="margin">
					<form  id="formid">
						<div class="add_style">
							 <ul>
							  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>用户编号：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="userid" name="title" type="text" data-title="用户编号"  class="col-xs-6"/></div></li>
							  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>专家职称：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="expert_academic" name="author" type="text"  data-author="专家职称"  class="col-xs-6"/></div></li>
							  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>专家姓名：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="expert_name" name="author" type="text"  data-author="专家姓名"  class="col-xs-6"/></div></li>
							  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>原图：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><img id="epiccc" style="height:100px;" src="" />    <button id="update" onclick="uppicture();" >修改图片</button></div></li>
							  <li class="clearfix" id="pcu" type="hidden"><label class="label_name col-xs-1">
							  	  <i>*</i>图片链接：&nbsp;&nbsp;</label>
						          <style>
							          #container{
							          	margin-left: 80px;
				 ...
				 <div class="Button_operation btn_width">
					  <button class="btn button_btn bg-deep-blue"  style="margin-left: 30%;" type="button" onclick="updateExpert()">确认修改</button>
					  <button class="btn button_btn bg-deep-blue"  style="margin-left: 10px;" type="button" onclick="returnFind()">返回</button>
				 </div>
				</div>		 
		   </div>
  ...
  <script type="text/javascript">
    ...
    $(function() {
     ...
     var expert_picture=document.getElementById("expert_picture").value;
     if(expert_picture==""){
     	document.getElementById("expert_picture").value=imageName;
     }else{
     	expert_picture+=";"+imageName;
     	document.getElementById("expert_picture").value=expert_picture;
     }
    });
