...
<div class="add_style">
 <ul>
  <li class="clearfix"><label name="协议标题" class="label_name col-xs-1"><i>*</i>协议标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" data-protocol_title="协议标题"  name="protocol_title" type="text" value=""  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议类型：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" data-protocol_type="协议类型"  name="protocol_type" type="text" value=""  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议状态：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_nickname" data-status_state="协议状态" name="status_state" type="text"  value=""  class="col-xs-6"/></div></li>
...
var n=0;
 ...
 return false;
    ...
    //alert("送达方式的公司对该公司"+JSON.stringify(jsondata))
    var object = JSON.stringify(jsondata);
    if(confirm("确认提交操作吗？")){
	    ajaxPost("<%=basePath%>admin_protocol/addProtocol",object,"json","json",addProtocol);
	  }else{
	    return false;
	    }
