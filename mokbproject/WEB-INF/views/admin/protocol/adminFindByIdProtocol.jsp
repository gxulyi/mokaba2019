...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe"   data-protocol_title="协议标题"  name="protocol_title" type="text" disabled="disabled"  value="${pEntity.protocol_title}"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议类型：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" data-protocol_type="协议类型"  name="protocol_type" type="text" disabled="disabled"  value="${pEntity.protocol_type}"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议状态：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_nickname" data-status_state="协议状态"  name="status_state" type="text" disabled="disabled"   value="${pEntity.status_state}"  class="col-xs-6"/></div></li>
