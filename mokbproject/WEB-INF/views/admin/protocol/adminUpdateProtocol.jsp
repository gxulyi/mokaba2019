...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" data-protocol_title="协议标题"  name="protocol_title" type="text" value="${pEntity.protocol_title}"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议类型：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" data-protocol_type="协议类型"  name="protocol_type" type="text" value="${pEntity.protocol_type}"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议状态：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_nickname" data-status_state="协议状态"  name="status_state" type="text"  value="${pEntity.status_state}"  class="col-xs-6"/></div></li>
  
     <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>协议内容：&nbsp;&nbsp;</label>
     <div class="Add_content col-xs-11"><script id="editor" name="" type="text/plain" style="width:100%;height:500px;">${pEntity.protocol_content}</script></div>
     </li>  
 ...
 <div class="Button_operation btn_width">
    <button class="btn button_btn bg-deep-blue"  style="margin-left: 30%;" type="button" onclick="commit()">保存并提交</button>
...
var n=0;
 ...
 return false;
   ...
   if(n==1||UE.getEditor('editor').getContent()=="") return false;
    ...
    jsondata["protocol_id"]=${pEntity.protocol_id};
   // alert(JSON.stringify(jsondata));
    var object = JSON.stringify(jsondata);
    if(confirm("确认提交操作吗？")){
	    ajaxPost("<%=basePath%>admin_protocol/updateProtocol",object,"json","json",updateContent);
	  }else{
	    return false;
	    }
