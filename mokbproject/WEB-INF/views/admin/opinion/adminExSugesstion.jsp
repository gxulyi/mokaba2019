  ...
  <script type="text/javascript">
	...
	//  var currentPage=vsi.map.currentPage;
	 ...
	 // alert(11);
	  ...
	  ajaxPost("<%=basePath%>admin_opinion/adminFindByStatusState",object,"json","json",wait);
	  };
	  ...
	  if(confirm("确认删除该意见吗？")){
	  	   ajaxPost("<%=basePath%>admin_opinion/updateSugByStatus",object,"json","json",wait2);
	  }else{
	    return false;
	    }
	  }; 
      ...
      <div class="am-u-md-6 am-cf">
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
           <!--  <div class="am-btn-group am-btn-group-xs">
              <a href="admin_store/toAddStore"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</button></a>
            </div> -->
