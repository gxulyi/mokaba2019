...
<form id="formId1" name="formId1" method="post" action="" enctype="multipart/form-data">
	<div class="add_style">
		<div name="audio_url" id="views1" style="display:none" class="clearfix" >
...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>标题：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input style="width:300px" name="title" type="text" data-title="标题"  class="col-xs-6"/></div></li>
      ...
      <!--  -->
       ...
       <li name="audio_url" id="views4" style="display:none" class="clearfix"><label class="label_name col-xs-1"><i></i>所用金额：&nbsp;&nbsp;</label><div name="audio_url" class="Add_content col-xs-11"><input id="views5" name="audio_url"  data-audio_url="所用金额"  type="text" class="col-xs-6" value="请保留两位小数"></input></div></li>
          ...
          <i>*</i>图片链接：&nbsp;&nbsp;</label>
          <input type="hidden" name="pictures_url"  id="pictures_url" data-pictures_url="图片" >
          <style>
          #container{
          margin-left: 80px;
          }
 ...
 return false;
  ...
  ajaxPost("<%=basePath%>admin_news/addNews",object,"json","json",AddConten);
   ...
   if(data.state==0){
     ...
     switch(news_type){
     	case 1:
     		window.parent.location.href="<%=basePath%>admin_news/toFindnews";
     		break;
     	case 2:
     		window.parent.location.href="<%=basePath%>admin_news/toFindDynamic";
     		break;
     	case 3:
     		window.parent.location.href="<%=basePath%>admin_news/toFindFunds";
     		break;
     	case 4:
     		window.parent.location.href="<%=basePath%>admin_news/toFindViews";
     		break;
     	default:
     		window.parent.location.href="<%=basePath%>admin/index";
     		break;
     }
   }
