...
<script type="text/javascript">
	function wait(data){
	  ...
	  function addsver(){
	      ...
	      var mode_id=document.getElementById("psMode").value;
	      var  server_id ='${pServer.server_id}';
	      var server_picture=document.getElementById("sver_picture").value;
          var effective_time=document.getElementById("ser_date").value;
	      var server_intro=UE.getEditor('editor').getContent();
	     /// alert(effective_time);
	      var server_name=document.getElementById("ser_name").value;
	     
	      var paramData;
	 	  var paramData={server_id:server_id,mode_id:mode_id,type_id:type_id,server_picture:server_picture,effective_time:effective_time,server_intro:server_intro,server_name:server_name};                               
	  	  var object = JSON.stringify(paramData);
	 	  ajaxPost("<%=basePath%>/admin_personal/updatePersonalSver",object,"json","json",wait);
	 	  
	  }
	  
	function showMode(vsi){
		var htmlstr2="<option value='${pServer.mode_id}'>${pServer.mode_name}</option>";
	...
	var object = JSON.stringify(paramData);
	 ajaxPost("<%=basePath%>admin_personal/findPersonalMode",object,"json","json",showType);
	}
	function showType(vsi){
		var htmlstr2="<option value='${pServer.type_id}'>${pServer.type_name}</option>";
...
<form  id="formid">
			<div class="am-btn-group am-btn-group-xs">
              <a ><span class=""></span> 请选择服务方式：</a>
              <select id="psType"  style="width:140px;" onchange="findSomeType(this.value)">
                <option value="">请选择服务方式</option>
              </select>
            </div>
            
            <div class="am-btn-group am-btn-group-xs" style="margin-top:10px;">
              <a ><span class=""></span> 请选择服务类型：</a>
              <select id="psMode" style="width:140px;" onchange="findSomeMode(this.value)">
...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-2"><i>*</i>服务名：&nbsp;&nbsp;</label><div  class="Add_content col-xs-10"><input id="ser_name" name="title" type="text" data-title="服务名"  class="col-xs-6" value="${pServer.server_name}"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-2"><i>*</i>有效期：&nbsp;&nbsp;</label><div  class="Add_content col-xs-10"><input id="ser_date" name="author" type="text"  data-author="有效期"  class="col-xs-6" value="${pServer.effective_time}"/></div></li>
  
   <!-- 
	<li class="clearfix"><label class="label_name col-xs-1">
	
    <i>*</i>服务方式：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
    
    <select name="" id="server_mode" class="text_add" style="width:300px" class="col-xs-6">
       <option value="0">请选择服务方式</option>
       <option value="1">帮助</option>
       <option value="2">推荐</option>
       <option value="3">健身锻炼</option>
       <option value="4">健身产品</option>
     </select>
-->
          ...
          .add_style .label_name{width: 130px;}
          </style>
           <div id="wrapper" >
        <div id="container" style="width:85.5%;">
            <!--头部，相册选择和格式选择-->
            <div id="uploader">
                <div class="queueList">
                <div id="storePic">
                    ...
                    <div id="dndArea" class="placeholder">
                        ...
                        <input id="pictu" value="${pServer.server_picture}">
                        <p>或将照片拖到这里，只需要一张</p>
                    </div>
                </div>
     ...
     <li class="clearfix"><label class="label_name col-xs-2"><i>*</i>内容介绍：&nbsp;&nbsp;</label>
     <div class="Add_content col-xs-10"><script id="editor" type="text/plain"  style="width:100%;height:500px;">${pServer.server_intro}</script></div>
     </li>  
 ...
 <div class="Button_operation btn_width">
    <button class="btn button_btn bg-deep-blue"  style="margin-left: 30%;" type="button" onclick="addsver()">保存并提交</button>
