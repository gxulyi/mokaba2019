...
<script type="text/javascript">
	function wait(data){
     ...
     //     alert("store_intro::"+store_intro);
	      ...
	      var paramData;
	 	  var paramData={mode_id:mode_id,type_id:type_id,server_picture:server_picture,effective_time:effective_time,server_intro:server_intro,server_name:server_name};                               
	  	  var object = JSON.stringify(paramData);
	 	  ajaxPost("<%=basePath%>/admin_personal/addServer",object,"json","json",wait);
...
<form  id="formid">
            ...
            <div class="am-btn-group am-btn-group-xs" style="margin-top:10px;">
              ...
              <select id="psMode"  style="width:140px;">
...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-2"><i>*</i>服务名：&nbsp;&nbsp;</label><div  class="Add_content col-xs-10"><input id="ser_name" name="title" type="text" data-title="服务名"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-2"><i>*</i>有效期：&nbsp;&nbsp;</label><div  class="Add_content col-xs-10"><input id="ser_date" name="author" type="text"  data-author="有效期"  class="col-xs-6"/></div></li>
...
-->
     ...
     <div class="Add_content col-xs-10"><script id="editor" type="text/plain" style="width:100%;height:500px;"></script></div>
     </li>  
