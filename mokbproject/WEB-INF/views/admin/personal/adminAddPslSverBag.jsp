	...
	function wait(data){
     ...
     //     alert("store_intro::"+store_intro);
	     ...
	     // alert(store_intro);
	      ...
	      var store_service=check_val.toString();
	      if(store_service==""){
	      	alert("请选择服务项目！");
	      }else{
	      var paramData;
	 	  var paramData={store_price:store_price,store_picture:store_picture,store_intro:store_intro,store_name:store_name,store_type:1,store_service:store_service};                               
	  	  var object = JSON.stringify(paramData);
	 	  ajaxPost("<%=basePath%>/admin_store/addStore",object,"json","json",wait);
	      }
	 	  
	  }
	
	
	function showServer(vsi){
     var htmlstr="";
     var listPersonalServer=vsi.personalServerData.listPersonalServer;
	     ...
	     var lpt=listPersonalServer;
	      for(var i=0;i<lpt.length;i++){
           htmlstr+="<input type='checkbox' name='check_server' value="+lpt[i].server_id+" /><span>"+lpt[i].server_name+"</span>";
                
    	  }
    	   htmlstr+="<br>";
    	  document.getElementById("server_check").innerHTML=htmlstr;
         }
    }
    function onloadd(){
	  //alert(11);
	  ...
	  var object = JSON.stringify(paramData);
	  ajaxPost("<%=basePath%>admin_personal/findPersonalSver",object,"json","json",showServer);
	  };
...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>服务包名：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="store_name" name="title" type="text" data-title="服务包名"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>价格：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="store_price" name="author" type="text"  data-author="价格"  class="col-xs-6"/></div></li>
  
  <div id="server_check" style="margin-left:110px;">
