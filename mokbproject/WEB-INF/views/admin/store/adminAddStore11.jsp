...
<script type="text/javascript">
	function wait(data){
	  alert("添加商品成功!");
	  window.parent.location.href="<%=basePath%>admin_store/toFindStore";
	  }
	  ...
	  function addstore(){
		  ...
		  var tutor_name="";
		  if(tutor_num==1){
		  	var tutor_name1=$("#tutor_name1").val();
		  	if(tutor_name1==null||tutor_name1==""){
		  		alert("请输入导师名字!");
		  		return;
		  	}
		  	tutor_name=tutor_name1;
		  }else if(tutor_num==2){
		  	var tutor_name1=$("#tutor_name1").val();
		  	if(tutor_name1==null||tutor_name1==""){
		  		alert("请输入导师名字!");
		  	...
		  	var tutor_name2=$("#tutor_name2").val();
		  	if(tutor_name2==null||tutor_name2==""){
		  		alert("请输入导师名字!");
		  		return;
		  	}
		  	tutor_name=tutor_name1+";"+tutor_name2;
		  }else{
		  	
		  }
		  
	 	  var paramData={store_price:store_price,store_picture:store_picture,store_intro:store_intro,store_name:store_name,store_type:0,class_hour:class_hour,tutor_num:tutor_num,tutor_name:tutor_name};                
...
<select id="tutor_num" name="tutor_num" style="margin-left: 5px;" onchange="selectNum(this.value)">
	<option value="0">请选择导师数量...</option>
