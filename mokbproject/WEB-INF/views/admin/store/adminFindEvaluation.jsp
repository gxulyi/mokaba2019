...
<%@ include file="../template/admin-header.jsp" %><!-- html头部文件 -->
...
<head>
  ...
  <script type="text/javascript">
  	 ...
  	 function deleteEvaluation(evaluation_id){
  	 	var status_state=3;
	    var paramData={evaluation_id:evaluation_id,status_state:status_state};                               
	 ...
	 function showEvaluation(data){
	 	...
	 	for(var i=0;i<listEvaluation.length;i++){
              ...
              "<div style='float: inherit;'>"+
                  ...
                  "<span><a id='evaluation_date'>"+listEvaluation[i].evaluation_date+"</a></span> &nbsp"+
  ...
  <div class="admin-content">
   ...
   <img style="width: 40px;height: 40px;cursor: pointer;position: absolute;top: 15px;right: 80px;"onclick="javascript:history.back(-1);" title="返回上一级" alt="" src="images/fhsyj.png">
    <div class="am-g">
		...
		<input hidden="hidden" id="store_id11" name="store_id11" type="email" id="user-email" placeholder="商品价格" value="${store_id}">
