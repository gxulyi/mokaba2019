...
<div class="add_style">
 ...
 <ul>
  ...
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>商品名称：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="store_name" name="title" type="text" data-title="商品名称"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>商品原价：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="prime_price" name="prime_price" type="text"  data-author="商品原价"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>销售价：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="store_price" name="store_price" type="text"  data-author="商品销售价"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>净含量：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="net_weight" name="net" type="text"  data-author="净含量"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix" id="fulls_money"><label class="label_name col-xs-1"><i>*</i>满减价：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="full_money" name="full_money" type="text"  data-author="满减价"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix" id="gives_money"><label class="label_name col-xs-1"><i>*</i>赠送金额：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="give_money" name="full_money" type="text"  data-author="赠送金额"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix" id="requireds_integral"><label class="label_name col-xs-1"><i>*</i>所需积分：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="required_integral" name="required_integral" type="text"  data-author="所需积分"  class="col-xs-6" disabled="disabled"/></div></li>	
  <li class="clearfix" id="start_dates"><label class="label_name col-xs-1"><i>*</i>开始时间：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="start_date" name="start_date" type="text"  data-author="开始时间"  class="col-xs-6" disabled="disabled"/></div></li>
  <li class="clearfix" id="end_dates"><label class="label_name col-xs-1"><i>*</i>结束时间：&nbsp;&nbsp;</label><div  class="Add_content col-xs-11"><input id="end_date" name="end_date" type="text"  data-author="结束时间"  class="col-xs-6" disabled="disabled"/></div></li>	
