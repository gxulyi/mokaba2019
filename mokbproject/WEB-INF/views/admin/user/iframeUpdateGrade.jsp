...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
   ...
   <div >
   <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="admin_user/updateGrade?user_grade_id=${user_grade_id}">  </iframe>
