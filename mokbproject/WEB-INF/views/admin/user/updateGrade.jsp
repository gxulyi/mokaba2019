...
<div class="add_style">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i></i>等级名字：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><p class="col-xs-6" id="grade_name">超级会员</p></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>等级描述：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_describe" name="title" type="text" value="等级描述"  class="col-xs-6"/></div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>等级昵称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11"><input id="grade_nickname" name="author" type="text"  value="黑卡巴会员"  class="col-xs-6"/></div></li>
  
     <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>等级介绍：&nbsp;&nbsp;</label>
     <div class="Add_content col-xs-11"><script id="editor" name="" type="text/plain" style="width:100%;height:500px;"></script></div>
     </li>  
...
var n=0;
 ...
 return false;
   ...
   if(n==1||UE.getEditor('editor').getContent()=="") return false;
    ...
    jsondata["user_grade_id"]=user_grade_id;
    var object = JSON.stringify(jsondata);
  ajaxPost("<%=basePath%>admin_user/updateUserGrade",object,"json","json",AddConten);

   function  AddConten(data){
   
   if(data.state==0){
   alert("修改成功!");
     window.parent.location.href="admin_user/toUserGradeIndex"; 
 	...
 	function onloadd(){
  	  ...
  	  //alert(user_grade_id);
	  var paramData;
	  var paramData={user_grade_id:user_grade_id};                               
	  var object = JSON.stringify(paramData);
	  ajaxPost("<%=basePath%>admin_user/findUserGrade",object,"json","json",showGrade);
	};
	window.onload=function(){
	  	onloadd();
	};     
    function showGrade(vc){
    	//alert(JSON.stringify(vc.object));
    	var userGrade=vc.object;
    	document.getElementById("grade_name").innerHTML=userGrade.grade_name;
    	document.getElementById("grade_describe").value=userGrade.grade_describe;
    	document.getElementById("grade_nickname").value=userGrade.grade_nickname;
    	UE.getEditor('editor').setContent(userGrade.grade_introduce);
    }  
