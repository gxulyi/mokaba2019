...
<div class="spacing_style" ></div>
 <div class="margin-bottom clearfix ">
  <div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
   <a href="javascript:void()" class="tile-button btn_Plate bg-deep-blue">
   ...
   <div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
   <a href="javascript:void()" class="tile-button btn_Plate bg-red ">
   <div class="carousel Module_info">
 ...
 <div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
   <a href="javascript:void()" class="tile-button btn_Plate bg-orange">
   <div class="carousel Module_info">
  ...
  <div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
   <a href="javascript:void()" class="tile-button btn_Plate bg-purple">
   <div class="carousel Module_info">
   ...
   <div class="col-xs-2 col-sm-2 col-md-2 col-lg-4">
   <a href="javascript:void()" class="tile-button btn_Plate bg-yellow">
   <div class="carousel Module_info">
